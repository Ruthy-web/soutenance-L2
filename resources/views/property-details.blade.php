...
<body>
            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                      ...
                      <li><a href="/property-details" class="active">Détails des logements</a></li>
                      <li><a href="/contact">Contactez nous</a></li>
                      <li><a href="#"><i class="fa fa-calendar"></i> Visiter</a></li>
                  </ul>   
  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <span class="breadcrumb"><a href="/locataire">Accueil</a>  /  Single Property</span>
...
<div class="section property-actions">
  <div class="container">
    <div class="row text-center">
      <!-- Contacter Bailleur -->
      <div class="col-lg-3 col-md-6 mb-4">
        <a href="/contacter-bailleur" class="action-card p-3 border rounded d-block text-decoration-none">
          <i class="fa fa-phone fa-2x mb-2 action-icon"></i>
          <h5>Contacter Bailleur</h5>
        </a>
      </div>
      
      <!-- Faire une Visite Virtuelle -->
      <div class="col-lg-3 col-md-6 mb-4">
        <a href="/visitevirtuelle" class="action-card p-3 border rounded d-block text-decoration-none">
          <i class="fa fa-vr-cardboard fa-2x mb-2 action-icon"></i>
          <h5>Faire une Visite Virtuelle</h5>
        </a>
      </div>
      ...
      <!-- Laisser un Avis -->
      <div class="col-lg-3 col-md-6 mb-4">
        <a href="/laisser-avis" class="action-card p-3 border rounded d-block text-decoration-none">
          <i class="fa fa-star fa-2x mb-2 action-icon"></i>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-3">
                      ...
                      <div class="icon-button">
                        <a href="#"><i class="fa fa-calendar"></i> Visiter</a>
                      </div>
                    </div>
                  </div>
                </div>
